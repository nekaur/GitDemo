...
public class AndroidBaseTest extends AppiumUtils{
	...
	public void ConfigureAppium() throws IOException
	{
		...
		prop.load(fis);
		//Script is dynamically witten that based on where the ip address property is coming from it will decide at run time ,first prefernece is given to maven ,if it false  it will then take from properties file
		//System.getProperty("ipAddress")!=null ? System.getProperty("ipAddress") ---                       if true it will take from maven
